...
export default {
	...
	startScroll(editor, e) {
		...
		this.moving = false;
		this.editor = editor;
		document.body.classList.add("mmb-scrollwheel-editor");
	...
	stopScroll() {
		...
		if (this.editor) {
			...
			document.body.classList.remove("mmb-scrollwheel-editor");
			this.editor = null;
		}
	},
	...
	createDot() {
		...
		this.dot.classList.add("mmb-scrollwheel-dot", "hidden");
	...
	activate() {
		...
		this.disposables.add(atom.config.observe("mmb-scrollwheel.speed", (value) => {
			this.speed = value;
		}));

		this.disposables.add(atom.config.observe("mmb-scrollwheel.threshold", (value) => {
